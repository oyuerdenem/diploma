...
export default function Order() {
  ...
  const fetchOrdersByOrder = async () => {
    try {
      ...
      <div className="w-full flex justify-between items-center mb-4">
        ...
        >
          <div className="flex space-x-4 text-xs">
            ...
            <button
              className="h-8 px-4 w-auto ml-3 bg-[#086A69] border rounded-lg flex justify-center items-center text-white hover:shadow"
              onClick={() => {
                handleButton(1);
              }}
            >
            ...
            <button
              className="h-8 px-4 w-auto ml-3 border rounded-lg flex justify-center items-center text-gray-700 bg-white hover:shadow"
              onClick={() => {
                handleButton(2);
              }}
            >
